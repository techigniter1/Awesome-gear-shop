...
https://awesome-gear-shop.vercel.app/

Add this link to your GitHub repository README by pushing the repo (instructions below).

How to push this project to GitHub (PowerShell)

1. Create a GitHub repository on github.com (via the web) and copy the repository HTTPS URL (e.g. https://github.com/yourusername/awesomegear.git) OR use the GitHub CLI (gh) to create it.

2. In PowerShell, run the following commands from the project root:

```powershell
cd "C:\Users\HP\OneDrive\Desktop\Ecommerce-AwesomeGear-main"
...
# add remote (replace the URL below with your repo URL)
git remote add origin https://github.com/<your-username>/<your-repo>.git

# push to GitHub (main or master depending on your default branch)
git branch -M main
git push -u origin main
```

If you prefer to use the GitHub CLI and it is installed, you can create and push in one command:

```powershell
cd "C:\Users\HP\OneDrive\Desktop\Ecommerce-AwesomeGear-main"
# creates repo on GitHub, sets it as origin and pushes
gh repo create your-username/awesomegear --public --source=. --remote=origin --push
```

Notes:
- Be sure to replace the remote URL or `your-username/awesomegear` with your actual GitHub username and desired repository name.
- Do NOT commit `.env.local` or any secret files. The `.gitignore` added above prevents common secrets from being committed.
- After pushing, you can add the live demo link (https://awesome-gear-shop.vercel.app/) to the repository description or the top of the README on GitHub.
